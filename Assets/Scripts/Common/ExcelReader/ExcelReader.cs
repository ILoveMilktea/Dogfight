...
public partial class ExcelReader : MonoBehaviour
{
    ...
    public static void RemoveOldData()
    {
        ...
        try
        {
            List<string> oldScripts = new List<string>(Directory.GetFiles(m_ScriptPath, "Tables.cs"));
        ...
        try
        {
            List<string> oldTables = new List<string>(Directory.GetDirectories(m_TablePath, "*"));
